...
import com.example.healthcare.service.WorkflowProgressService
...
class AiTaskController(
    ...
    fun getTaskProgress(@PathVariable taskId: String): List<WorkflowProgressEvent> =
        workflowProgressService.getProgress(taskId)
