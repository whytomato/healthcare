...
@mcp.resource("healthcare://knowledge/safety")
def safety_note() -> str:
    return "No medical knowledge base is configured for this MCP server."


@mcp.tool()
def search_medical_knowledge(query: str) -> dict[str, object]:
    """Knowledge search placeholder; configure a real knowledge base before use."""
    load_env_file()
    ...
    return {
        ...
        "query": query,
        "required_config": ["MEDICAL_KNOWLEDGE_BASE"],
        "message": "No real medical knowledge base is configured.",
    }
